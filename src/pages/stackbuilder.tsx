    ...
    <>
      ...
      {isLibraryOpen && (
        <>
          ...
          >
            <button className='toggle-output pointer-events-none cursor-not-allowed hover:bg-opacity-80 text-slate-400 bg-slate-500 hover:text-slate-400 hover:bg-slate-500'>
